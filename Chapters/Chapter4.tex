...
\]
we are also implementing a weighting function $w$ such as Gaussian to emphasize the center of the window giving less relevance to the terms that are outside the center.
