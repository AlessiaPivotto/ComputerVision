...
To grab the most salient points from the DoGs, each pixel from a given DOG is compared to its 26 neighbors ($8$ in the same level, $9$ above and $9$ below) as shown in Figure \ref{fig:dogs2}.
