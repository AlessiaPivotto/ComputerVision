...
\\\textit{NB: It's good practice to have only one main edge component inside a cell.} 
\\Then, for each pixel in the cell we compute the orientation of edges(\textit{Take a pixel, take his neighbor and see if there is an edge or not}).
